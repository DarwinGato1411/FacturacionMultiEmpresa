...
//             query.setParameter("codTipoambiente", codTipoambiente);
    ...
    public List<Cliente> FindClienteLikeNombre(String buscar) {
        ...
        try {
            ...
            em = HelperPersistencia.getEMF();
            em.getTransaction().begin();
            Query query = em.createQuery("SELECT c FROM Cliente c WHERE (c.cliNombre like :cliNombre ) OR c.cliNombres LIKE '%CONSUMIDOR%'");
...
//            query.setParameter("codTipoambiente", codTipoambiente);
    ...
    public List<Cliente> FindClienteLikeRazonSocial(String buscar) {
        ...
        try {
            ...
            em = HelperPersistencia.getEMF();
            em.getTransaction().begin();
            Query query = em.createQuery("SELECT c FROM Cliente c WHERE (c.cliNombres like :cliRazonSocial OR c.cliApellidos LIKE :cliApellidos ) OR c.cliNombres LIKE '%CONSUMIDOR%'");
