 ...
 * @author Darwin
 */
public class XAdESBESSignatureApi extends GenericXMLSignature {
     ...
     *
     */
    public XAdESBESSignatureApi(String fileToSign) {
        super();
    ...
    public static void firmar(String xmlPath, String nomreArchivoFirmado, String ClaveFima, String pathFima, String FOLDER_BASE_FIRMADO) throws Exception {
        ...
        signature.setPathSignature(pathFima);
    ...
    protected String getSignatureFileName() {
        return XAdESBESSignatureApi.nameFile;
    }

    @Override
    protected String getPathOut() {
        return XAdESBESSignatureApi.pathFile;
    }
